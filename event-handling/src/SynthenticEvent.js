...
export default function SynthenticEvent() {
    function SynthenticEvent(e) {
        console.log("SynthenticEvent 클릭");
        console.log(e);
  ...
  return (
    <div>
    <h1>SynthenticEvent</h1>
    <button onClick={SynthenticEvent}>SynthenticEvent 콘솔에 찍기</button>
    <br/>
